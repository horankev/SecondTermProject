...
gwr_tidy_results1 <- as.data.frame(gwr.model$SDF)[3:11] %>% 
  gather() %>% 
  mutate(global= c(rep(gwr.model$lm$coefficients[2], 572),
                   rep(gwr.model$lm$coefficients[3], 572),
                   rep(gwr.model$lm$coefficients[4], 572),
                   rep(gwr.model$lm$coefficients[5], 572),
                   rep(gwr.model$lm$coefficients[6], 572),
                   rep(gwr.model$lm$coefficients[7], 572),
                   rep(gwr.model$lm$coefficients[8], 572),
                   rep(gwr.model$lm$coefficients[9], 572),
                   rep(gwr.model$lm$coefficients[10], 572))) %>% 
...
bins <- seq(-10,10,1)
all_elections_gwrpca$bins_low_qual <- cut(coef_low_qual_gwrpca, bins)
all_elections_gwrpca$bins_over65 <- cut(coef_over65_gwrpca, bins)
all_elections_gwrpca$bins_student <- cut(coef_student_gwrpca, bins)
all_elections_gwrpca$bins_deprived <- cut(coef_deprived_gwrpca, bins)
all_elections_gwrpca$bins_density <- cut(coef_density_gwrpca, bins)
all_elections_gwrpca$bins_leave_EU <- cut(coef_leave_EU_gwrpca, bins)
all_elections_gwrpca$bins_unemployed <- cut(coef_unemployed_gwrpca, bins)
all_elections_gwrpca$bins_born_elsewhere <- cut(coef_born_elsewhere_gwrpca, bins)
...
bins <- seq(-5,5,1)
all_elections_gwrgwpca$bins_low_qual <- cut(coef_low_qual_gwpca, bins)
all_elections_gwrgwpca$bins_over65 <- cut(coef_over65_gwpca, bins)
all_elections_gwrgwpca$bins_student <- cut(coef_student_gwpca, bins)
all_elections_gwrgwpca$bins_deprived <- cut(coef_deprived_gwpca, bins)
all_elections_gwrgwpca$bins_density <- cut(coef_density_gwpca, bins)
all_elections_gwrgwpca$bins_leave_EU <- cut(coef_leave_EU_gwpca, bins)
all_elections_gwrgwpca$bins_unemployed <- cut(coef_unemployed_gwpca, bins)
all_elections_gwrgwpca$bins_born_elsewhere <- cut(coef_born_elsewhere_gwpca, bins)
...
```{r}
saveRDS(gwr_gwpca_table, "con_diff_gwr_gwpca.rds")
saveRDS(gwr_pca_table, "con_diff_gwr_pca.rds")
saveRDS(gwr_table1, "con_diff_gwr.rds")
saveRDS(table_pca, "con_diff_lm_pca.rds")
saveRDS(table_lm_coeff1, "con_diff_lm.rds")
```
