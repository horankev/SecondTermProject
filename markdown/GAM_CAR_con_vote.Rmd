...
ggplot(all_elections_polygons) + 
  geom_histogram(aes(con_change1),binwidth = 5, fill="#AFC1CC", colour="#517281") + 
  xlab("Proportion") + 
...
pl1 <- ggplot(cons_constit,aes(fill=fitted)) + geom_sf(lwd=.25, colour="black") +
  scale_fill_distiller(name='Fitted\nValue',type = "div") + 
  labs(title = "Conservative Vote Percentage", 
       subtitle = "2019")
